...
@pytest.mark.asyncio
async def test_read_file(project_root: Any, mock_file_ops_config: Any) -> None:
    mock_file_ops_config.allowed_directories = [str(project_root)]
...
async def test_write_file_new(
    mock_confirm: Any, project_root: Any, mock_file_ops_config: Any
) -> None:
    mock_file_ops_config.allowed_directories = [str(project_root)]
    mock_file_ops_config.require_write_confirmation = True
...
@pytest.mark.asyncio
async def test_write_file_tty_confirm(
    project_root: Any, mock_file_ops_config: Any
) -> None:
    mock_file_ops_config.allowed_directories = [str(project_root)]
    mock_file_ops_config.require_write_confirmation = True
...
@pytest.mark.asyncio
async def test_write_file_offset_new(
    project_root: Any, mock_file_ops_config: Any
) -> None:
    mock_file_ops_config.allowed_directories = [str(project_root)]
    mock_file_ops_config.require_write_confirmation = False
...
@pytest.mark.asyncio
async def test_write_file_offset_existing(
    project_root: Any, mock_file_ops_config: Any
) -> None:
    mock_file_ops_config.allowed_directories = [str(project_root)]
    mock_file_ops_config.require_write_confirmation = False
...
@pytest.mark.asyncio
async def test_write_file_offset_limit_replace(
    project_root: Any, mock_file_ops_config: Any
) -> None:
    mock_file_ops_config.allowed_directories = [str(project_root)]
    mock_file_ops_config.require_write_confirmation = False
...
@pytest.mark.asyncio
async def test_read_log_file_bypasses_blacklist_and_gitignore(
    project_root: Any,
    mock_file_ops_config: Any,
) -> None:
    """Covers file_ops.py line 70: log_file path returns early, skipping checks."""
    log_path = project_root / "app.log"
    log_path.write_text("log entry")

    mock_file_ops_config.allowed_directories = [str(project_root)]
    mock_file_ops_config.log_file = "app.log"
    content = await read_file(str(log_path))
